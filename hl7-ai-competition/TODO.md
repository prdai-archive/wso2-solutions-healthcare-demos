...
- The AMP-in-compose boot (amp + amp-init + care-loop-ai-service through the gateway, MCP proxy, and trace export) has not been run end to end yet; the otel ingest may also need AMP_AGENT_API_KEY set once an agent identity exists.
