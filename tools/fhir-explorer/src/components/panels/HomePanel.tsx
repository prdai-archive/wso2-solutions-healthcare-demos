...
const HEALTHCARE_URL = "https://wso2.com/solutions/healthcare/";
const FHIR_SERVER_URL = "https://github.com/wso2/fhir-server";
const CONTACT_URL = "https://wso2.com/contact/?ref=Healthcare";
    ...
    <div className="space-y-6">
      <section className="relative overflow-hidden rounded-xl border bg-gradient-to-br from-primary/10 via-accent/40 to-transparent p-6 sm:p-8">
        ...
        <p className="mt-5 max-w-3xl text-sm leading-relaxed text-muted-foreground">
          ...
          <TextLink href={FHIR_SERVER_URL}>WSO2 FHIR server</TextLink> (R4). This server is provided
          for evaluation and testing of the WSO2 FHIR server.
        </p>
      </section>
      ...
      <section className="flex gap-3 rounded-xl border border-destructive/30 bg-destructive/5 p-5">
        ...
        <div>
          ...
          <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
            ...
            patient identifiers, or other confidential data. All resources on this server are
            publicly readable and writable by anyone.
          </p>
        </div>
      </section>
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        <Fact icon={FlaskConical} title="Synthetic data only">
          The server is reset weekly and reloaded with a fixed set of synthetic test data, so
          anything you create here will be removed without notice.
        </Fact>
